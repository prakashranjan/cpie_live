     ...
     $result=mysql_query($qry);
				...
				$prp= mysql_fetch_row($pr);
                           ...
                           echo'<div class="col-sm-6 ">';
							 ...
							 if($rowori[1]!=$rowori[8] && $rowori[9]!=1){		  
                                   ...
                                   //poll place
                                     ...
                                     $jql="SELECT option_id FROM poll_count WHERE username='$usern' AND image_id='$rowori[0]'";
                                     $dar=mysql_query($jql);
                 ...
                 echo '<div id="'.$rowori[0].'polldiv"><div class="panel-body">';
                                       ...
                                       $qry="SELECT option_id,poll_option,hits FROM poll_option WHERE image_id='$rowori[0]'";
				$res=mysql_query($qry);
				...
				if($rowori[11]!=NULL){$imagedetails = getimagesize($rowori[10]);
                                ...
                                echo'<div class="text-center"><img class="img-thumbnail" style="width:100%" height="100%"src="'.$rowori[11].'"></div>';}}					     
                                    ...
                                    <div class="input-group">
									  ...
									  $jql="SELECT s_id FROM slam WHERE username='$usern' AND chat_id='$rowori[0]'";
                                      $dar=mysql_query($jql);
