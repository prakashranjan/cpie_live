...
//{
 ...
 $sql="INSERT INTO channel_poll_count (option_id,image_id,username) VALUES ('$opt_val','$poll_id','$usern')";
			     $toname=mysql_query($sql);
				
				

				$mql56="update channel_poll_option set hits= hits+1 where image_id='$poll_id' AND option_id='$opt_val'";
				$kar56=mysql_query($mql56);
                                
                 echo '<div class="panel-body">';
                                       $k='A';
                                       $qry="SELECT option_id,poll_option,hits FROM channel_poll_option WHERE image_id='$poll_id'";
				$res=mysql_query($qry);
