...
$logchat="SELECT log FROM member WHERE username='$usern'";
                ...
                $qry="SELECT * FROM channel_comments WHERE image_id='$comment_post_id' AND event > '$logro[0]' ORDER BY comment_id   ";
        magic($qry);
/*
 $hint="chat";
if($anon!=1){
...
$c_info=$comment_info;
			...
			$c_info=carbonlink($c_info);
                ...
                if($result){
                $qry="update channel_post set comment_count=comment_count + 1 where image_id='$comment_post_id'";
