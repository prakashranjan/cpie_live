...
$count=cleankar($_GET['counter']);
                 ...
                 $kqry="SELECT topic_id,category,cdesc,wall,private,topic_mode FROM topic where category in (select category from private_member where username='$usern' and allow=1) ORDER BY views DESC";
$y=-1;
$j=0;
//$p=0;
