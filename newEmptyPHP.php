 <!--<div id="moveform"><hr>
        ...
        <input   type="text" value="" id="tagy" class=" form-control input-md" data-role="tagsinput">
                ...
                <!-- /top nav -->
                    ...
                    <div  id="blackback"class="full col-sm-9">
                       ...
                       if(edit()){
                           ...
                           echo'<div class="panel" id="wall_tab" style="margin-bottom:0px;border-color:#8784ff;">
