<?php
 ...
 }else{echo'<h4><strong>Hey!</strong>insert query nhi chala</h4><br>';}
 
 
 if($data && $data2) { if(mkdir("user_files/$userName",0760)){echo "chal gya mkdir";}
 else {echo "nhi chala mkdir";}
 ...
 echo'<h4><strong>Hey!</strong> now login with your login id</h4><br>'; 
...
<body onLoad="setTimeout('delayer()', 3000)">
    ...
    if(isset($_POST['newregister'])) 
     ...
     echo'<h4><strong>Hey!</strong>i think all done</h4><br>';
         ...
         echo'<h4><strong>Hey!</strong>kuch nhi hua</h4><br>';
     }
     }else{
         echo"<h4>Unable to sign up</h4><br>";
     } 
